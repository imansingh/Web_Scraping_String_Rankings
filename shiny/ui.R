shinyUI(dashboardPage(
  ...
  dashboardBody(
    tabItems(
      tabItem(tabName = "selector", h2("Find the Right String Based on Your Criteria"),
              fluidRow(h3("Select your String Preferences, Tester Criteria and General Criteria")),
              fluidRow(  
                tabBox(
                  #title = "First tabBox", 
                  id = "selectorInput", 
                  ...
                  tabPanel("String Preferences",
                           h3("Select how important these factors are to you, on a scale of 1-10"),
                           fluidRow(
                  ...
                  tabPanel("Tester Criteria",
                           h3("Only include reviews from testers with these characteristics:"),
